...
print('IG account home page initalized. Sleep for {} seconds before attempting to post'.format(3))
sleep_timer(3)
wait.until(EC.element_to_be_clickable((By.XPATH, "//button[@class='mTGkH']"))).click()

# Pyautogui methods
print('Starting keyboard methods')

## Load meme as IG story input
pyautogui.press('F4', interval=.5)
pyautogui.hotkey('ctrl','a',interval=.5)
pyautogui.press('backspace',interval=.5)
...
print('Upload button selected. Wait for {} seconds'.format(3))
sleep_timer(3)
